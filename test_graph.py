...
if __name__ == "__main__":
    with open("/home/rsalesc/Dev/joern/parsed/test/test.cpp/nodes.csv", encoding="utf-8") as fn:
        with open("/home/rsalesc/Dev/joern/parsed/test/test.cpp/edges.csv", encoding="utf-8") as fe:
